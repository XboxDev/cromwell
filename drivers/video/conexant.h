...
int conexant_calc_vga_mode(xbox_av_type av_type, unsigned char pll_int, volatile void **mode_out);
int conexant_calc_hdtv_mode(xbox_hdtv_mode hdtv_mode, unsigned char pll_int, volatile void **mode_out);
